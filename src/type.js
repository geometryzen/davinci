...
Sk.builtin.type = function(name, bases, dict)
{
    ...
    else
    {
        ...
        klass.prototype.tp$repr = function()
        {
            ...
            var cname = "";
            if (mod) cname = mod.v + ".";
            return Sk.builtin.stringToPy("<" + cname + name + " object>");
        };
...
Sk.builtin.type.tp$repr = function() { return Sk.builtin.stringToPy("<type 'type'>"); };
...
Sk.builtin.type.prototype.tp$getattr = function(name)
{
    ...
    if (this['$d'])
    {
        var res = this['$d'].mp$lookup(Sk.builtin.stringToPy(name));
        if (res !== undefined)
        {
            return res;
        }
...
{
    var mro = type.tp$mro;
    var pyname = Sk.builtin.stringToPy(name);
    var base;
    var res;
    var i;
